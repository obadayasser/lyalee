...
import { db, collection, getDocs, addDoc, doc, updateDoc, query, where, getDoc } from '../FireBase/Firebase';
  ...
  return (
    <>
      ...
      <Container className="my-4 one" style={{ paddingTop: "150px" }}>
        <div className='head'>
          <button className='head' disabled>كل المنتجات</button>
        </div>
        <Row>
